...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	63a50513          	addi	a0,a0,1594 # 800670 <main+0x112>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	63a50513          	addi	a0,a0,1594 # 800690 <main+0x132>
...
exit(int error_code) {
  ...
  800136:	56650513          	addi	a0,a0,1382 # 800698 <main+0x13a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800192:	52278793          	addi	a5,a5,1314 # 8006b0 <main+0x152>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001ee:	4faa8a93          	addi	s5,s5,1274 # 8006e4 <main+0x186>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001f6:	70eb8b93          	addi	s7,s7,1806 # 800900 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80044c:	29860613          	addi	a2,a2,664 # 8006e0 <main+0x182>
  ...
  80045e:	27660613          	addi	a2,a2,630 # 8006d0 <main+0x172>
  ...
  800470:	25c40413          	addi	s0,s0,604 # 8006c8 <main+0x16a>
  ...
  8004fa:	1d240413          	addi	s0,s0,466 # 8006c8 <main+0x16a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800510:	1bda0a13          	addi	s4,s4,445 # 8006c9 <main+0x16b>
...
int main(void) {
  ...
  800564:	46850513          	addi	a0,a0,1128 # 8009c8 <error_string+0xc8>
int main(void) {
  ...
  80056e:	b35ff0ef          	jal	ra,8000a2 <cprintf>
    ...
    int pid = fork();
  800572:	bcfff0ef          	jal	ra,800140 <fork>

    if (pid == 0) {
  800576:	e525                	bnez	a0,8005de <main+0x80>
        // ==== 子进程 ====
        // 此时应共享物理页，shared_data 读取无误
        assert(shared_data == 100);
  800578:	00001717          	auipc	a4,0x1
  80057c:	a8872703          	lw	a4,-1400(a4) # 801000 <shared_data.0>
  800580:	06400793          	li	a5,100
  800584:	00001417          	auipc	s0,0x1
  800588:	a7c40413          	addi	s0,s0,-1412 # 801000 <shared_data.0>
  80058c:	0af71563          	bne	a4,a5,800636 <main+0xd8>
        cprintf("Child:  Initial read OK. Now writing...\n");
  800590:	00000517          	auipc	a0,0x0
  800594:	49050513          	addi	a0,a0,1168 # 800a20 <error_string+0x120>
        
        // 2. 尝试写入，触发 Write Page Fault -> COW 发生
        shared_data = 200; 
  800598:	0c800493          	li	s1,200
        cprintf("Child:  Initial read OK. Now writing...\n");
  80059c:	b07ff0ef          	jal	ra,8000a2 <cprintf>
        shared_data = 200; 
  8005a0:	c004                	sw	s1,0(s0)
        
        cprintf("Child:  Write finished. Value = %d\n", shared_data);
  8005a2:	400c                	lw	a1,0(s0)
  8005a4:	00000517          	auipc	a0,0x0
  8005a8:	4ac50513          	addi	a0,a0,1196 # 800a50 <error_string+0x150>
  8005ac:	2581                	sext.w	a1,a1
  8005ae:	af5ff0ef          	jal	ra,8000a2 <cprintf>
        assert(shared_data == 200);
  8005b2:	401c                	lw	a5,0(s0)
  8005b4:	2781                	sext.w	a5,a5
  8005b6:	02978163          	beq	a5,s1,8005d8 <main+0x7a>
  8005ba:	00000697          	auipc	a3,0x0
  8005be:	4be68693          	addi	a3,a3,1214 # 800a78 <error_string+0x178>
  8005c2:	00000617          	auipc	a2,0x0
  8005c6:	43660613          	addi	a2,a2,1078 # 8009f8 <error_string+0xf8>
  8005ca:	45d5                	li	a1,21
  8005cc:	00000517          	auipc	a0,0x0
  8005d0:	44450513          	addi	a0,a0,1092 # 800a10 <error_string+0x110>
  8005d4:	a53ff0ef          	jal	ra,800026 <__panic>
        exit(0);
  8005d8:	4501                	li	a0,0
  8005da:	b51ff0ef          	jal	ra,80012a <exit>
    } else {
        // ==== 父进程 ====
        if (wait() != 0) panic("wait failed");
  8005de:	b65ff0ef          	jal	ra,800142 <wait>
  8005e2:	e92d                	bnez	a0,800654 <main+0xf6>

        // 3. 检查父进程的数据是否被污染
        cprintf("Parent: Child exited. My value = %d\n", shared_data);
  8005e4:	00001597          	auipc	a1,0x1
  8005e8:	a1c5a583          	lw	a1,-1508(a1) # 801000 <shared_data.0>
  8005ec:	00000517          	auipc	a0,0x0
  8005f0:	4b450513          	addi	a0,a0,1204 # 800aa0 <error_string+0x1a0>
  8005f4:	aafff0ef          	jal	ra,8000a2 <cprintf>
        
        // 如果 COW 成功，父进程的值应仍为 100
        if (shared_data == 100) {
  8005f8:	00001717          	auipc	a4,0x1
  8005fc:	a0872703          	lw	a4,-1528(a4) # 801000 <shared_data.0>
  800600:	06400793          	li	a5,100
  800604:	02f70263          	beq	a4,a5,800628 <main+0xca>
             cprintf("COW Test Passed! Parent memory was protected.\n");
        } else {
             cprintf("COW Test Failed! Value changed to %d.\n", shared_data);
  800608:	00001597          	auipc	a1,0x1
  80060c:	9f85a583          	lw	a1,-1544(a1) # 801000 <shared_data.0>
  800610:	00000517          	auipc	a0,0x0
  800614:	4e850513          	addi	a0,a0,1256 # 800af8 <error_string+0x1f8>
  800618:	a8bff0ef          	jal	ra,8000a2 <cprintf>
        }
    }
    return 0;
  80061c:	60e2                	ld	ra,24(sp)
  80061e:	6442                	ld	s0,16(sp)
  800620:	64a2                	ld	s1,8(sp)
  800622:	4501                	li	a0,0
  800624:	6105                	addi	sp,sp,32
  800626:	8082                	ret
             cprintf("COW Test Passed! Parent memory was protected.\n");
  800628:	00000517          	auipc	a0,0x0
  80062c:	4a050513          	addi	a0,a0,1184 # 800ac8 <error_string+0x1c8>
  800630:	a73ff0ef          	jal	ra,8000a2 <cprintf>
  800634:	b7e5                	j	80061c <main+0xbe>
        assert(shared_data == 100);
  800636:	00000697          	auipc	a3,0x0
  80063a:	3aa68693          	addi	a3,a3,938 # 8009e0 <error_string+0xe0>
  80063e:	00000617          	auipc	a2,0x0
  800642:	3ba60613          	addi	a2,a2,954 # 8009f8 <error_string+0xf8>
  800646:	45b9                	li	a1,14
  800648:	00000517          	auipc	a0,0x0
  80064c:	3c850513          	addi	a0,a0,968 # 800a10 <error_string+0x110>
  800650:	9d7ff0ef          	jal	ra,800026 <__panic>
        if (wait() != 0) panic("wait failed");
  800654:	00000617          	auipc	a2,0x0
  800658:	43c60613          	addi	a2,a2,1084 # 800a90 <error_string+0x190>
  80065c:	45e5                	li	a1,25
  80065e:	00000517          	auipc	a0,0x0
  800662:	3b250513          	addi	a0,a0,946 # 800a10 <error_string+0x110>
